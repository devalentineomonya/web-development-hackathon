        ...
        <section id="services">
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4'>
                <div className="sm:flex justify-between items-center mb-20">
                    <h2 className="text-midnight_text text-4xl lg:text-5xl font-semibold mb-5 sm:mb-0">Popular Services.</h2>
                        ...
                        <div key={i}>
                            <div className='bg-white m-3 mb-12 px-3 pt-3 pb-12 shadow-course-shadow rounded-2xl h-full'>
                                <div className="relative rounded-3xl">
                                    <Image src={items.imgSrc} alt="service-image" width={100} height={100} className="m-auto clipPath h-[245px] w-full" />
                                    <div className="absolute right-5 -bottom-10 bg-secondary rounded-full h-24 p-2 aspect-square grid place-content-center">
                                        <h3 className="text-white uppercase text-center text-sm font-medium">Best <br /> Service</h3>
                                    </div>
                                </div>

                                <div className="px-3 pt-6">
                                    <Link href="#" className='text-2xl font-bold text-black max-w-full inline-block'>{items.heading}</Link>
                                    <h3 className='text-base font-normal pt-6 text-black/75'>{items.description}</h3>
                                    ...
                                    <div className="flex justify-between pt-6">
                                        <div className="flex gap-4">
                                            ...
                                            />
                                            <h3 className="text-base font-medium text-black opacity-75">{items.features}</h3>
                                        </div>
                                        <div className="flex gap-4">
                                            <Icon
                                                ...
                                                className="text-primary text-xl inline-block me-2"
                                            />
                                            <h3 className="text-base font-medium text-black opacity-75">{items.clients} clients</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
